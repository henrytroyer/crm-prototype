...
export default function RecruitmentDetailPanel({
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col overflow-hidden rounded-3xl border border-crm-taupe/20 bg-crm-surface p-2 shadow-sm">
      <div className="relative flex min-h-0 flex-1 flex-col overflow-hidden rounded-2xl bg-crm-surface">
        <div className="shrink-0 border-b border-crm-taupe/20 bg-crm-white px-6 py-4">
          <button
            type="button"
            onClick={onBack}
