        ...
        <div className="min-w-0 flex-1">
          {editing ? (
            <input
              ...
              className="w-full rounded-xl border border-crm-taupe/20 bg-crm-surface px-4 py-2 text-2xl font-semibold text-crm-heading outline-none focus:border-crm-slate focus:ring-2 focus:ring-crm-taupe/20"
            />
          ) : (
              ...
              {editing ? (
                <>
                  ...
                  <button
                    ...
                    disabled={saving}
                    className="rounded-xl border border-crm-taupe/20 px-4 py-2 text-sm font-medium text-crm-heading transition hover:bg-crm-taupe-50"
                  >
                    Cancel
                  </button>
                </>
