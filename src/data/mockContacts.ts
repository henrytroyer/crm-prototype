...
import { buildMockVolunteerDetail } from "./mockVolunteerDetail";
import {
...
function mockVolunteerFilesForContact(
  ...
  return buildMockVolunteerDetail({
    ...volunteer,
    profilePhotoUrl: contact.profilePhotoUrl ?? volunteer.profilePhotoUrl,
  }).files;
}
